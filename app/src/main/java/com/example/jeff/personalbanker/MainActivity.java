...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //buildNotification((int)preference.getFloat("goalAmount", 0.0f));
    }
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        Fragment newfragment = new FragmentSpendings();

        switch (position){
            case 0:
                newfragment = new FragmentCalculate();
            ...
            case 1:
                ...
                break;
            case 2:
                newfragment = new GoalProgress();
                transaction.replace(R.id.container, newfragment);
                transaction.addToBackStack("Goal Progress");
    ...
    public void restoreActionBar() {
        ...
        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#3344dd")));
    }
